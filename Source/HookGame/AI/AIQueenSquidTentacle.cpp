...
void AAIQueenSquidTentacle::SetStartValues()
{
...
void AAIQueenSquidTentacle::PlatformStatus(float DeltaSeconds)
{
	if (bIsDead)
		return;
...
void AAIQueenSquidTentacle::HandleDeath()
{
	//	Platforms should not despawn!
}
